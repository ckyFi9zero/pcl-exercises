...
void setViewerPose(pcl::visualization::PCLVisualizer& viewer, const Eigen::Affine3f& viewer_pose) {
    Eigen::Vector3f pos = viewer_pose.translation();
    Eigen::Vector3f look_at = viewer_pose * Eigen::Vector3f(0, 0, 1);  // 视线方向
    Eigen::Vector3f up_dir = viewer_pose.rotation() * Eigen::Vector3f(0, -1, 0);  // 上向量
